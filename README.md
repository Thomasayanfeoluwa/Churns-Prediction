...
| Modeling               | Logistic Regression, XGBoost, Gradient Boosting            |
| Deployment             | Streamlit, Docker, AWS/Heroku                              |
| Experiment Tracking    | MLflow, Git                                                |

---

## 🔍 Key Features  
- Predicts probability of churn for each customer  
- Visual dashboard of churn risk, feature importance & trends  
- Exportable reports for retention strategy teams  
